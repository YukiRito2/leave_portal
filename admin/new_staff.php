                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6 mobile-inputs">
                                                                ...
                                                                <input type="hidden" id="edit_id" name="edit_id"
                                                                    value="<?php echo isset($_GET['id']) ? $_GET['id'] : 'null'; ?>">
                                                                <form enctype="multipart/form-data">
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <label for="userName-2" class="block">Perfil
                                                                                del Personal *</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <label for="userName-2" class="block">Nombre
                                                                                *</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <label for="userName-2"
                                                                                class="block">Segundo Nombre</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <label for="userName-2" class="block">Número
                                                                                de Teléfono *</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                            <label for="userName-2"
                                                                                class="block">Designación *</label>
                                                                        </div>
                                                                        <div class="col-sm-12">
                                                                            <input type="text" id="designation"
                                                                                name="designation" autocomplete="off"
                                                                                class="form-control" placeholder=""
                                                                                value="<?php echo isset($row['designation']) ? $row['designation'] : ''; ?>">
                                                                        </div>
                                                                    </div>
                                                                    <h4 class="sub-title">Género *</h4>
                                                                    <div class="form-group row">
                                                                        <div class="col-sm-12">
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label>
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            <?php echo (isset($row['gender']) && $row['gender'] === 'Female') ? 'checked="checked"' : ''; ?>>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label>
                                                                                        <input type="radio"
                                                                                            ...
                                                                                            <?php echo (isset($row['gender']) && $row['gender'] === 'Male') ? 'checked="checked"' : ''; ?>>
                                                            ...
                                                            <div class="col-sm-6 mobile-inputs">
                                                                <h4 class="sub-title">Detalles de la Empresa</h4>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="userName-2"
                                                                            class="block">Departamento *</label>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <select
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="userName-2" class="block">ID del
                                                                            Personal *</label>
                                                                    </div>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" id="staff_id" name="staff_id"
                                                                            ...
                                                                            class="form-control" placeholder=""
                                                                            value="<?php echo isset($row['staff_id']) ? $row['staff_id'] : ''; ?>">
                                                                    </div>
                                                                    <div class="col-sm-2">
                                                                        <i id="generate"
                                                                            class="fa fa-cog btn btn-primary"
                                                                            style="cursor: pointer; padding: 10px; border-radius: 5px;"
                                                                            aria-hidden="true" title="Generar ID"></i>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <label for="userName-2" class="block">Correo
                                                                            Electrónico *</label>
                                                                    </div>
                                                                    <div class="col-sm-12">
                                                                        <input type="email" id="email" name="email"
                                                                            ...
                                                                            placeholder=""
                                                                            value="<?php echo isset($row['email_id']) ? $row['email_id'] : ''; ?>">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="form-radio">
                                                                            <div class="radio radiofill radio-inline">
                                                                                <label>
                                                                                    <input type="radio"
                                                                                        name="is_supervisor" value="1"
                                                                                        <?php echo (isset($row['is_supervisor']) && $row['is_supervisor'] == 1) ? 'checked="checked"' : ''; ?>>
                                                                                    <i class="helper"></i>Sí
                                                                                </label>
                                                                            </div>
                                                                            <div class="radio radiofill radio-inline">
                                                                                <label>
                                                                                    <input type="radio"
                                                                                        name="is_supervisor" value="0"
                                                                                        <?php echo (isset($row['is_supervisor']) && $row['is_supervisor'] == 0) ? 'checked="checked"' : ''; ?>>
                                                                                    <i class="helper"></i>No
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <h4 class="sub-title">Tipo de Rol</h4>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-12">
                                                                        <div class="form-radio">
                                                                            <div class="radio radiofill radio-inline">
                                                                                <label>
                                                                                    <input type="radio" name="role"
                                                                                        value="Staff"
                                                                                        <?php echo (isset($row['role']) && $row['role'] === 'Staff') ? 'checked="checked"' : ''; ?>>
                                                                            ...
                                                                            <div class="radio radiofill radio-inline">
                                                                                <label>
                                                                                    <input type="radio" name="role"
                                                                                        value="Manager"
                                                                                        <?php echo (isset($row['role']) && $row['role'] === 'Manager') ? 'checked="checked"' : ''; ?>>
                                                                                    <i class="helper"></i>Gerente
                                                                                </label>
                                                                            </div>
