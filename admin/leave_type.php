    ...
    <div id="pcoded" class="pcoded">
                                    ...
                                    <div class="page-body">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <button type="button"
                                                            ...
                                                            data-modal="modal-13">
                                                            <i class="icofont icofont-plus m-r-5"></i> Nuevo Tipo de
                                                            Permiso
                                                        </button>
                                                    </div>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            ?>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <span
                                                                                                            style="font-weight: 600;"><?php echo $row['leave_type']; ?></span>
                                                                                                    </td>
                                                                                                    <td><?php echo $row['description']; ?>
                                                                                                    </td>
                                                                                                    <td><?php echo $row['assign_days']; ?>
                                                                                                    </td>
                                                                                                    <td>
                                                                                                        <?php
                                                                                            $status = $row['status'];
                                                                                            if ($status == 1) {
                                                                                                echo '<span style="color: green; font-weight: 600;">Activo</span>';
                                                                                            } else {
                                                                                                echo '<span style="color: red; font-weight: 600;">Inactivo</span>';
                                                                                            }
                                                                                            ?>
                                                                                                    </td>
                                                                                                    <td>
                                                                                            ...
                                                                                            ?>
                                                                                                    ...
                                                                                                    <td
                                                                                                        ...
                                                                                                        <a href="#"
                                                                                                            ...
                                                                                                            data-name="<?php echo $row['leave_type']; ?>"
                                                                                                            data-description="<?php echo $row['description']; ?>"
                                                                                                            data-assigned="<?php echo $row['assign_days']; ?>"
                                                                                                            data-status="<?php echo $row['status']; ?>">
                                                                                                            <i
                                                                                                                class="icofont icofont-ui-edit"></i>
                                                                                                        </a>
                                                                                                        <a href="#"
                                                                                                            class="delete-btn text-muted"
                                                                                                            data-toggle="tooltip"
                                                                                                            data-placement="top"
                                                                                                            title=""
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            <div class="md-content" style="max-width: 400px;">
                                                <h3 class="f-26">Agregar Tipo de Permiso</h3>
                                                <div>
                                                    <input hidden type="text" class="form-control type-id"
                                                        name="type-id">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-social-ebuddy"></i></span>
                                                    ...
                                                    <div class="input-group">
                                                        <textarea class="form-control description" name="description"
                                                            placeholder="Descripción aquí" spellcheck="false"
                                                            rows="5"></textarea>
                                                    </div>
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" id="save-btn"
                                                            class="btn btn-primary waves-effect m-r-20 f-w-600 d-inline-block save_btn">Guardar</button>
                                                        <button type="submit" id="update-btn"
                                                            class="btn btn-primary waves-effect m-r-20 f-w-600 update_btn"
                                                            style="display:none;">Actualizar</button>
                                                        <button type="button"
                                                            class="btn btn-primary waves-effect m-r-20 f-w-600 md-close d-inline-block close_btn">Cerrar</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        $('#save-btn').click(function(event) {
            ...
            (async () => {
                ...
                if (data.dname.trim() === '' || data.description.trim() === '' || data.assigned
                .trim() === '' || data.status.trim() === '') {
                    Swal.fire({
                        icon: 'warning',
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 'success') {
                            Swal.fire({
                                ...
                                html: 'Name : ' + data['dname'],
                                confirmButtonColor: '#01a9ac',
                                confirmButtonText: 'OK'
                            }).then((result) => {
                                if (result.isConfirmed) {
                                    $('.md-close').trigger(
                                    'click'); // close the modal form
                                    location.reload();
                                }
                            });
                        } else {
