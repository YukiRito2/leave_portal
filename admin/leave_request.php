        ...
        <div class="pcoded-container navbar-wrapper">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>Portal de Permisos - Todos los Permisos</h4>
                                                        <span>Verificar y responder a solicitudes de permiso</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <nav class="navbar navbar-light bg-faded m-b-30 p-10">
                                                    <ul class="nav navbar-nav">
                                                        <li class="nav-item active">
                                                            <a class="nav-link" href="#!">Filtrar por Estado: <span
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            <a class="nav-link dropdown-toggle" href="#!" id="bystatus"
                                                                ...
                                                                <?php echo $selectedLeaveStatusName; ?>
                                                            </a>
                                                            <div class="dropdown-menu" aria-labelledby="bystatus">
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Mostrar todos') ? 'active' : ''; ?>"
                                                                    href="?leave_status=Show all">Mostrar todos</a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Pendiente') ? 'active' : ''; ?>"
                                                                    href="?leave_status=0">Pendiente</a>
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Aprobado') ? 'active' : ''; ?>"
                                                                    href="?leave_status=1">Aprobado</a>
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Cancelado') ? 'active' : ''; ?>"
                                                                    href="?leave_status=2">Cancelado</a>
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Retirado') ? 'active' : ''; ?>"
                                                                    href="?leave_status=3">Retirado</a>
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Rechazado') ? 'active' : ''; ?>"
                                                                    href="?leave_status=4">Rechazado</a>
                                                            </div>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div id="leaveInformation" class="col-lg-3">
                                                ...
                                                <div class="card job-right-header">
                                                    <div class="card-header">
                                                        <h5>Información del Estado del Permiso</h5>
                                                    </div>
                                                        ...
                                                        <div class="card m-t-15">
                                                            <div class="auth-box card-block">
                                                                <div class="row m-b-20">
                                                                    <div class="col-md-12 confirm">
                                                                        <h3 class="text-center txt-primary"><i
                                                                            ...
                                                                            Revisión de Permiso</h3>
                                                                    </div>
                                                                </div>
                                                                <input hidden type="text" class="form-control leave-id"
                                                                    name="leave-id">
                                                                <p class="text-inverse text-left m-t-15 f-16">
                                                                    <b>Estimado <span id="modalReviewer"></span></b>,
                                                                </p>
                                                                <p id="modalMessage"
                                                                    class="text-inverse text-left m-b-20"></p>
                                                                <ul class="text-inverse text-left m-b-30">
                                                                    <li><strong>Tipo de Permiso: </strong> <span
                                                                            id="modalLeaveType"></span></li>
                                                                    <li><strong>Días Solicitados: </strong> <span
                                                                            id="modalRequestedDays"></span></li>
                                                                ...
                                                                <div class="row m-t-15">
                                                                    <div class="col-md-12">
                                                                        <button type="button"
                                                                            class="btn btn-primary btn-md btn-block waves-effect text-center">Actualizar</button>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <p class="text-inverse text-left m-b-0 m-t-10">
                                                                        </p>
                        ...
                        if (formValues) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    console.log(
                                        `RESPONSE HERE: ${responseObject.message}`
                                    );
                                    if (response && responseObject.status ===
                                        'success') {
                                ...
                                error: function(xhr, status, error) {
                                    ...
                                    console.log('Data HERE: ' + JSON.stringify(
                                        data));
                                    Swal.fire('Error!',
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.delete-leave', function(event) {
                    ...
                    console.log("LEAVE STATUS FOR DELETE HERE " + (leaveStatus == "Pending") +
                        leaveStatus);
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '.review-btn', function() {
                    ...
                    var reviewer =
                        '<?php echo ($session_sfirstname ? $session_sfirstname : '') . " " . ($session_smiddlename ? $session_smiddlename : '') . " " . ($session_slastname ? $session_slastname : ''); ?>';
                    ...
                    switch (leaveStatusValue) {
                        case 0: // Pending
                            if (today > endDate) {
                                modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                                    "</b> el <b>" + formattedSubmissionDate +
                                    "</b> para el período del <b>" + formattedStartDate +
                                ...
                                modalMessage =
                                    "Está a punto de revisar la solicitud de permiso pendiente presentada por <b>" +
                                    staff + "</b> el <b>" + formattedSubmissionDate +
                                    "</b> para el período del <b>" + formattedStartDate +
                                    "</b> al <b>" + formattedEndDate +
                                    "</b>. Por favor, revise los detalles cuidadosamente y decida si aprueba o rechaza la solicitud.";
                            }
                            break;
                        case 1: // Approved
                            if (today < startDate) {
                                modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                                    ...
                                    "</b> para el período del <b>" + formattedStartDate +
                                    "</b> al <b>" + formattedEndDate +
                                    "</b> ha sido aprobada. Puede optar por retirar la aprobación si es necesario.";
                            } else if (today >= startDate && today <= endDate) {
                                modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                                    "</b> el <b>" + formattedSubmissionDate +
                                    "</b> para el período del <b>" + formattedStartDate +
                                    "</b> al <b>" + formattedEndDate +
                                    "</b> está actualmente en progreso.";
                            } else {
                                modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                                    "</b> el <b>" + formattedSubmissionDate +
                                    "</b> para el período del <b>" + formattedStartDate +
                                    "</b> al <b>" + formattedEndDate + "</b> ha sido completada.";
                            }
                            break;
                        case 2: // Cancelled
                            modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                            ...
                            break;
                        case 3: // Recalled
                            modalMessage = "La solicitud de permiso aprobada presentada por <b>" +
                                staff +
                                "</b> el <b>" + formattedSubmissionDate +
                                "</b> para el período del <b>" + formattedStartDate + "</b> al <b>" +
                                formattedEndDate + "</b> ha sido retirada.";
                            break;
                        case 4: // Rejected
                            modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                                "</b> el <b>" + formattedSubmissionDate +
                        ...
                        default:
                            modalMessage =
                                "Está a punto de revisar la solicitud de permiso presentada por <b>" +
                                staff +
                                "</b> el <b>" + formattedSubmissionDate +
                                "</b> para el período del <b>" + formattedStartDate + "</b> al <b>" +
                                formattedEndDate +
    ...
    `);
                    ...
                    if (leaveStatusValue === 0) { // Pending
                        ...
                        if (today >= startDate && today <= endDate) {
                            ...
                            updateButtonHTML =
                                '<button type="button" class="btn btn-disabled btn-md btn-block waves-effect text-center status-update" disabled>Esta solicitud <b style="color: #eb3422;"> HA EXPIRADO </b></button>';
                        }
                    } else if (leaveStatusValue === 2) { // Cancelled
                        if (today < startDate) {
                            updateButtonHTML =
                            ...
                            updateButtonHTML =
                                '<button type="button" class="btn btn-disabled btn-md btn-block waves-effect text-center status-update" disabled>Esta solicitud <b style="color: #eb3422;"> FUE CANCELADA </b></button>';
                        }
                    } else if (leaveStatusValue === 4) { // Rejected
                        updateButtonHTML =
                            '<button type="button" class="btn btn-disabled btn-md btn-block waves-effect text-center status-update" disabled>Esta solicitud <b style="color: #eb3422;"> FUE RECHAZADA </b></button>';
                    } else if (leaveStatusValue === 3) { // Recalled
                        updateButtonHTML =
                            '<button type="button" class="btn btn-disabled btn-md btn-block waves-effect text-center status-update" disabled>Esta solicitud <b style="color: #eb3422;"> FUE RETIRADA </b></button>';
                    }
                    ...
                    function performInitialCheck() {
                        ...
                        if (leaveStatusValue == stat) {
                            ...
                            $('.status-update').prop('disabled', true).removeClass('btn-primary')
                                .addClass('btn-disabled');
                        } else {
                            // If they are different, enable the update button
                            $('.status-update').prop('disabled', false).removeClass('btn-disabled')
