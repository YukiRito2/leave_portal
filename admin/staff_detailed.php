                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                                                ...
                                                                <div class="media-left">
                                                                    <a class="profile-image">
                                                                        <img class="user-img img-radius"
                                                                            ...
                                                                            src="<?php echo isset($row['image_path']) ? htmlspecialchars($row['image_path']) : '../files/assets/images/user-card/img-round1.jpg'; ?>"
                                                                            alt="user-img">
                                                                    </a>
                                                                </div>
                                                                <div class="media-body row">
                                                                    <div class="col-lg-12">
                                                                        <div class="user-title">
                                                                            <h2><?php echo htmlspecialchars($row['first_name'] . ' ' . $row['middle_name'] . ' ' . $row['last_name']); ?>
                                                                            </h2>
                                                                            <span
                                                                                class="text-white"><?php echo htmlspecialchars($row['designation']); ?></span>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-xl-9">
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="card">
                                                                            <div class="card-header">
                                                                                <h5 class="card-header-text">Acerca del
                                                                                    Personal</h5>
                                                                            </div>
                                                                                                            ...
                                                                                                            <table
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td><?php echo htmlspecialchars($row['designation']); ?>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <th
                                                                                                                        ...
                                                                                                                        <td><?php echo htmlspecialchars($row['is_supervisor'] == 1 ? 'Sí' : 'No'); ?>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                </tbody>
                                                                                                            </table>
                                                                                                                ...
                                                                                                                <tbody>
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td><a
                                                                                                                                href="#!"><span
                                                                                                                                    class="__cf_email__"
                                                                                                                                    data-cfemail="4206272f2d02273a232f322e276c212d2f"><?php echo htmlspecialchars($row['email_id']); ?>&#160;</span></a>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <th
                                                                                                                        ...
                                                                                                                        <td><?php echo htmlspecialchars($row['phone_number']); ?>
                                                                                                                        </td>
                                                                                                                    </tr>
                                                                                                                    <tr>
                                                                                                                        <th
                                                        ...
                                                        <div class="card m-t-15">
                                                            <div class="auth-box card-block">
                                                                    ...
                                                                    <ul class="list-group">
                                                                        <li
                                                                            ...
                                                                            <div class="checkbox-fade fade-in-primary">
                                                                                ...
                                                                                <span class="text"
                                                                                    style="margin-left: 15px;">Tipos de
                                                                                    Permiso</span>
                                                                            </div>
                                                                            <span class="text"
                                                                ...
                                                                <div class="row m-t-15">
                                                                    <div class="col-md-12">
                                                                        <button type="button" id="saveLeaveTypesBtn"
                                                                            class="btn btn-primary btn-md btn-block waves-effect text-center">Guardar</button>
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <div class="row">
                                                                    <div class="col-md-10">
                                                                        <p class="text-inverse text-center m-b-0">Puedes
                                                                            asignar diferentes tipos de permiso a tus
                                                                            empleados.</p>
                                                                        <p class="text-inverse text-left text-warning">
                                                                            <b>Nota:</b> Los tipos de permiso que han
                                                                            sido utilizados por el empleado no pueden
                                                                            ser reasignados y estarán deshabilitados.
                                                                        </p>
                                                                    </div>
                                                                    <div class="col-md-2">
                                ...
                                ";
                                                                ...
                                                                <div class="row m-t-15">
                                                                    <div class="col-md-12">
                                                                        <button type="button" id="assignSupervisorBtn"
                                                                            class="btn btn-primary btn-md btn-block waves-effect text-center">Asignar
                                                                            Supervisor</button>
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <div class="row">
                                                                    <div class="col-md-10">
                                                                        <p class="text-inverse text-left m-b-0">Puedes
                                                                            asignar supervisores a tus empleados.</p>
                                                                        <p class="text-inverse text-left"><b>Por favor
                                                                                selecciona el supervisor adecuado para
                                                                                cada empleado.</b></p>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                                        <!-- <img src="..\files\assets\images\auth\Logo-small-bottom.png" alt="small-logo.png"> -->
                                ...
                                <form class="md-float-material">
                                    <div class="card m-t-15">
                                        <div class="auth-box card-block">
                                            <div class="row m-b-20">
                                                <div class="col-md-12">
                                                    <h3 class="text-center txt-primary">Cambiar tu Contraseña</h3>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <div class="row m-t-15">
                                                <div class="col-md-12">
                                                    <button id="change_password" type="button"
                                                        class="btn btn-primary btn-md btn-block waves-effect text-center">Cambiar</button>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <p class="text-inverse text-left"><b>Serás autenticado después de
                                                            cambiar la contraseña.</b></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
