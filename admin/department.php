                                        ...
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-lg-4">
                                                <button type="button"
                                                    ...
                                                    data-modal="modal-13">
                                                    <i class="icofont icofont-plus m-r-5"></i> Nuevo Departamento
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="page-body">
                                                                ...
                                                                <div class="dropdown-secondary dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdown1"
                                                                        ...
                                                                        <a class="dropdown-item waves-light waves-effect"
                                                                            ...
                                                                            Personal</a>
                                                                        <a class="dropdown-item waves-light waves-effect edit-btn md-trigger"
                                                                            href="#" data-modal="modal-13"
                                                                            data-original-title="Editar"
                                                                            data-id="<?= $department['id'] ?>"
                                                                            data-name="<?= $department['name'] ?>"
                                                                            data-description="<?= $department['desc'] ?>"><span
                                                                                class="point-marker bg-warning"></span>Editar</a>
                                                                        <a class="dropdown-item waves-light waves-effect delete-btn"
                                                                            href="#" data-original-title="Eliminar"
                                                                            data-id="<?= $department['id'] ?>"><span
                                                                                class="point-marker bg-success"></span>Eliminar</a>
                                                                    </div>
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            <div class="md-content" style="max-width: 400px;">
                                                <h3 class="f-26">Agregar Departamento</h3>
                                                <div>
                                                    <input hidden type="text" class="form-control department-id"
                                                        name="department-id">
