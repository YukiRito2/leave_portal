                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="card-header-text"><i
                                                                class="icofont icofont-ui-note m-r-10"></i> Detalles de
                                                            la Tarea</h5>
                                                    </div>
                                                        ...
                                                        <table class="table table-border table-xs">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        <div class="btn-group">
                                                                            <a href="#"><?php echo isset($row['priority']) ? $row['priority'] : ''; ?>
                                                                                prioridad</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <div class="dropdown-secondary dropdown d-inline-block">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdown3"
                                                                        ...
                                                                        <a class="dropdown-item waves-light waves-effect"
                                                                            href="new_task.php?id=<?= $id ?>&edit=1"><i
                                                                                class="icofont icofont-edit-alt m-r-10"></i>Editar
                                                                            tarea</a>
                                                                        <a class="remove-task dropdown-item waves-light waves-effect"
                                                                            href="#!"><i
                                                                                class="icofont icofont-close m-r-10"></i>Eliminar</a>
                                                                    </div>
                                            ...
                                            <div class="col-xl-8 col-lg-12 pull-xl-4">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5><i class="icofont icofont-tasks-alt m-r-5"></i>
                                                        ...
                                                        <div class="f-right">
                                                            <div class="dropdown-secondary dropdown">
                                                                <button id="status-dropdown"
                                                                    ...
                                                                    <?php echo $row['status'] == "Pending" ? 'Pendiente' : ($row['status'] == "In Progress" ? 'En Progreso' : ($row['status'] == "Completed" ? 'Completada' : 'Pendiente')); ?>
                                                                </button>
                                                                <?php if ($_SESSION['srole'] === 'Admin' || $_SESSION['srole'] === 'Manager' || $row['assigned_by'] == $_SESSION['slogin']): ?>
                                                                    <div class="dropdown-menu" aria-labelledby="dropdown2"
                                                                        data-dropdown-in="fadeIn"
                                                                        data-dropdown-out="fadeOut">
                                                                        <a class="dropdown-status dropdown-item waves-light waves-effect <?php echo $row['status'] == "Pending" ? 'active' : ''; ?>"
                                                                            href="#!" data-status="Pending"
                                                                            data-task-id="<?php echo $row['id']; ?>">Pendiente</a>
                                                                        <a class="dropdown-status dropdown-item waves-light waves-effect <?php echo $row['status'] == "In Progress" ? 'active' : ''; ?>"
                                                                            href="#!" data-status="In Progress"
                                                                            data-task-id="<?php echo $row['id']; ?>">En
                                                                            Progreso</a>
                                                                        <a class="dropdown-status dropdown-item waves-light waves-effect <?php echo $row['status'] == "Completed" ? 'active' : ''; ?>"
                                                                            href="#!" data-status="Completed"
                                                                            data-task-id="<?php echo $row['id']; ?>">Completada</a>
                                                                    </div>
                                                                <?php endif; ?>
                                                                <!-- end of dropdown menu -->
                                                            </div>
