                                                            ...
                                                            <table class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                                                        <tr>
                                                                            <td><strong><?php echo htmlspecialchars($row['first_name'] . ' ' . $row['middle_name'] . ' ' . $row['last_name']); ?></strong>
                                                                            </td>
                                                                ...
                                                                <tbody>
                                                                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $fromDate ? htmlspecialchars($fromDate) : '-'; ?>
                                                                            </td>
                                                                            <td><?php echo $toDate ? htmlspecialchars($toDate) : '-'; ?>
                                                                            </td>
                                                                        </tr>
                                                                    <?php endwhile; ?>
                                                                </tbody>
