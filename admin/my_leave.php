                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>Portal de Permisos - Mi Solicitud de Permiso</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="card col-xl-12 col-md-12">
                                                <div class="card-header">
                                                    <h5>Resumen de Solicitudes de Permiso <?php echo $leaveTypeCount; ?>
                                                    </h5>
                                                ...
                                                <div class="row card-block">
                                                    ...
                                                    <div class="col-12 text-center">
                                                        <div class="alert"
                                                            ...
                                                            <p class="m-b-0">No hay resumen de solicitudes de permiso
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <?php endif; ?>
                                                            ...
                                                            <div class="card m-t-15">
                                                                <div class="auth-box card-block">
                                                                    <div class="row m-b-20">
                                                                        <div class="col-md-12 confirm">
                                                                            <h3 class="text-center txt-primary"><i
                                                                                ...
                                                                                Detalles de la Solicitud de Permiso</h3>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <p
                                                                                class="text-inverse text-left m-b-0 m-t-10">
                                                                            </p>
