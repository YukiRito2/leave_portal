                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col-sm-6 mobile-inputs">
                                                                ...
                                                                <form>
                                                                    ...
                                                                    FROM tblemployees WHERE 1=1";
                                                                                    ...
                                                                                    echo '<option value="" disabled selected>Seleccionar empleado</option>';
                                                            ...
                                                            <div class="col-sm-6 mobile-inputs">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <label for="start_date" class="block">Fecha de
                                                                            Inicio</label>
                                                                        <input name="start_date" id="dropper-animation"
                                                                            class="form-control start_date" type="text"
                                                                            autocomplete="off" placeholder=""
                                                                            value="<?php echo isset($row['start_date']) ? $row['start_date'] : ''; ?>">
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <label for="due_date" class="block">Fecha de
                                                                            Fin</label>
                                                                                ...
                                                                                <div class="radio radiofill radio-inline">
                                                                                    <label>
                                                                                        <input type="radio" name="priority"
                                                                                            value="High"
                                                                                            <?php echo $selected_priority == 'High' ? 'checked' : ''; ?>>
                                                                                        <i class="helper"></i>Alta
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio radiofill radio-inline">
                                                                                    <label>
                                                                                        <input type="radio" name="priority"
                                                                                            value="Medium"
                                                                                            <?php echo $selected_priority == 'Medium' ? 'checked' : ''; ?>>
                                                                                        <i class="helper"></i>Media
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio radiofill radio-inline">
                                                                                    <label>
                                                                                        <input type="radio" name="priority"
                                                                                            value="Low"
                                                                                            <?php echo $selected_priority == 'Low' ? 'checked' : ''; ?>>
                                                        ...
                                                        <div class="form-group">
                                                            <textarea name="description" id="summernote" cols="30"
                                                                rows="10"
                                                                class="form-control summernote"><?php echo isset($row['description']) ? $row['description'] : ''; ?></textarea>
                                                        </div>
                                                        <div class="row">
                                                            <label class="col-sm-5"></label>
                                                            <div class="col-sm-5">
                                                                <?php if (isset($row) && !empty($row)): ?>
                                                                    <button id="tasks-update" type="submit"
                                                                        class="btn btn-primary m-b-0">Actualizar</button>
                                                                <?php else: ?>
                                                                    <button id="tasks-add" type="submit"
        ...
        <script>
            $(document).ready(function() {
                $("#summernote").summernote({
                    ...
                    fontNames: ['Arial', 'Arial Black', 'Courier New', 'Georgia', 'Impact',
                        'Lucida Console', 'Tahoma', 'Times New Roman', 'Trebuchet MS', 'Verdana',
                        'Comic Sans MS', 'Palatino Linotype', 'Segoe UI', 'Open Sans', 'Source Sans Pro'
                    ],
