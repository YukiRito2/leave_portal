                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>Portal de Permisos - Solicitud de Permiso de Supervisados
                                                        </h4>
                                                        <span>Verifica y responde a las solicitudes de permiso</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <ul class="nav navbar-nav">
                                                        ...
                                                        <li class="nav-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="bystatus">
                                                                ...
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Pending') ? 'active' : ''; ?>"
                                                                ...
                                                                <a class="dropdown-item <?php echo ($selectedLeaveStatusName === 'Rejected') ? 'active' : ''; ?>"
            ...
            switch (leaveStatusValue) {
                ...
                case 2: // Cancelled
                    modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                        ...
                        "</b> al <b>" + formattedEndDate + "</b> ha sido cancelada.";
                    break;
                case 3: // Recalled
                    modalMessage = "La solicitud de permiso aprobada presentada por <b>" + staff +
                        "</b> el <b>" + formattedSubmissionDate + "</b> para el período del <b>" +
                        formattedStartDate + "</b> al <b>" + formattedEndDate +
                        "</b> ha sido retirada.";
                    break;
                case 4: // Rejected
                    modalMessage = "La solicitud de permiso presentada por <b>" + staff +
                        "</b> el <b>" +
                        formattedSubmissionDate + "</b> para el período del <b>" + formattedStartDate +
                        "</b> al <b>" + formattedEndDate + "</b> ha sido rechazada.";
                    break;
                default:
                    modalMessage =
    ...
    `);
            ...
            function performInitialCheck() {
                ...
                if (leaveStatusValue == stat) {
                    ...
                    $('.status-update').prop('disabled', true).removeClass('btn-primary').addClass(
                        'btn-disabled');
                } else {
                    // If they are different, enable the update button
                    $('.status-update').prop('disabled', false).removeClass('btn-disabled').addClass(
                        'btn-primary');
                }
            }
