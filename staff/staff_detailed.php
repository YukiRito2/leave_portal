                                                    ...
                                                    <ul class="nav nav-tabs md-tabs tab-timeline" role="tablist"
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" data-toggle="tab"
                                                                href="#personal" role="tab">Información del Personal</a>
                                                            <div class="slide"></div>
                                                        </li>
                                                    </ul>
                                                </div>
                                                                ...
                                                                <div class="card m-t-15">
                                                                    <div class="auth-box card-block">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-10">
                                                                                <p
                                                                                    class="text-inverse text-center m-b-0">
                                                                                    Puedes asignar diferentes tipos de
                                                                                    permiso a tus empleados.</p>
                                                                                <p
                                                                                    class="text-inverse text-left text-warning">
                                                                                    <b>Nota:</b> Los tipos de permiso
                                                                                    que han sido utilizados por el
                                                                                    empleado no pueden ser reasignados y
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-10">
                                                                                <p class="text-inverse text-left m-b-0">
                                                                                    Puedes asignar supervisores a tus
                                                                                    empleados.</p>
                                                                                <p class="text-inverse text-left"><b>Por
                                                                                        favor selecciona el supervisor
                                                                                        adecuado para cada empleado.</b>
                                                                                </p>
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <!-- <img src="..\files\assets\images\auth\Logo-small-bottom.png" alt="small-logo.png"> -->
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-10">
                                                                                <p class="text-inverse text-left">
                                                                                    <b>Serás autenticado después de
                                                                                        restablecer la contraseña.</b>
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
